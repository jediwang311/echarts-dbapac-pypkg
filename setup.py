...
NAME = 'echarts-dbapac-pypkg'
AUTHOR = 'Jediwang'
VERSION = '0.0.1'
EMAIL = 'jedi.wang@aliyun.com'
LICENSE = 'MIT'
DESCRIPTION = (
    'pyecharts map extension - DBSchenker APAC region - python package'
)
URL = 'https://github.com/jediwang311/Jediwang/echarts-dbapac-pypkg'
...
SETUP_COMMANDS = install_cmd_for(
    ...
    'echarts_dbapac_pypkg/resources/echarts-dbapac-js')
...
class PublishCommand(Command):
    ...
    def run(self):
        try:
            ...
            rmtree(os.path.join(HERE, 'echarts_dbapac_pypkg.egg-info'))
        except OSError:
            pass
